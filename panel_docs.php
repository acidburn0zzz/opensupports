<div class="panelbox">
	...
	<div class="description"><?php echo $TEXT['Docs and Guides description']; ?></div>
	<table class="ticketlist">
		...
		?>
		<tr class="trlist">
			<td class="tdlist"><div class="ntext"><a href="upanel.php?id=doc&doc=<?php echo $reg[id]; ?>"><?php echo $reg[title]; ?></div></td>
